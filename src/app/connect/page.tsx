      ...
      <main className={styles.main}>
        ...
        <section className="contact-us bg-body">
          ...
          <div className="section-content">
            ...
            <div className="row">
              <div className="general-content col-md-10">
                  <div className="headline-content">
                    <h2 className="fs-1">
                      <a id="section-contact">Connect with BADD</a>
                    </h2>
                    <p className="fs-4 my-4">
                      If your family is facing addiction, overdose risk, incarceration, or a mental health crisis, you do not have to navigate it alone. BADD-SF offers support for families of addicts, drug use help, recovery resources, and connections to community support in San Francisco.
                    </p>
                  </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="general-content col-md-5">
                  ...
                  <p className="fs-4">
                    Need support for a loved one struggling with addiction or drug use?
                  </p>

                  <p className="fs-4">  
                    Call BADD-SF: <br/>
                    <a href={`tel:${GLOBALS.GLOBAL_PHON1A}`}>{GLOBALS.GLOBAL_PHON1B}</a><br/>
                    <a href={`tel:${GLOBALS.GLOBAL_PHON1A}`}>{GLOBALS.GLOBAL_PHON1A}</a><br/>
                  </p>

                  <p className="fs-4">
                    Or email: <a href="mailto:contact@badd-sf.org" className="text-nowrap">contact@badd-sf.org</a> with any questions or concerns.
                  </p>
