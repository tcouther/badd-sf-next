            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-7">
                <div className="p-2">
                  ...
                  <p><small>BADD’s Federal Tax ID #{GLOBALS.GLOBAL_EIN}</small></p>
          ...
          <div className="section-content">
            ...
            <div className="row">
              <div className="general-content col-md-7 col-sm-12">
                <p className="fs-3">
                  <strong>This isn’t just a health issue. It’s a justice issue.</strong>
                </p>
              </div>
            </div>
            <div className="row">
