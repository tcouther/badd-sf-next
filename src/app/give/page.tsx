...
export const metadata: Metadata = {
  title: 'Give',
  description: "Support Brothers Against Drug Deaths through your donation and help expand advocacy, family support services, recovery programs, and community outreach."
};
